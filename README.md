...
Der Logger ist eine "black box" und sollte im Autostart Modus laufen. Eine Bedienung über die UI ist nur dann notwendig wenn eine GPX Datei heruntergeladen oder gelöscht werden soll.<img src="./doc/ESP32_GPS-Logger.png" align="right" width="250" />
